...
config.General.requestName   = 'singleElectron-17A-v1_new'
...
config.Data.inputDataset = '/SingleElectron/Run2017A-PromptReco-v3/MINIAOD'
...
config.Data.outputDatasetTag = 'singleElectron-17A-v1_new'
